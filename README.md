...
2. Добавить разбор загруженного XML обратно в поля формы.
3. Добавить автосохранение формы генерации в `sessionStorage`.
4. Подключить тесты backend-сервиса генерации и валидации.
5. Настроить CI: backend build, frontend build, lint, tests.
